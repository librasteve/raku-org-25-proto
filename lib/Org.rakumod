...
sub SITE is export {
    site :@tools, :register[Hilite.new], :theme-color<pink>, :bold-color<lime>,
        page #:REFRESH(7),
            title => 'raku®',
...
#                    ];
                ...
                div [
                    ...
                    div :align<center>, [
                        install;
                        h5 "Uniquely powerful: Roles & Inheritance, Hypers & Metas, Numerics, Sets & Junctions, Unicode Regex, Smartmatching, CLI...";
                    ];

                    vignette [
                        article [
                            h3 'Roles & Inheritance';
